...
append_js $sc_web_path/templates/components.html components/js/search_film_by_genre_and_actor_component/search_film_by_genre_and_actor_component.js
append_css $sc_web_path/templates/components.html components/css/search_film_by_genre_and_actor_component.css
